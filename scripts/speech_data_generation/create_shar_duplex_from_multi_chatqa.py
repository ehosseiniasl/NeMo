...
def create_shar_from_manifest(manifest, out_shar_dir, num_shard=10, overlap_sec=0.64, audio_dir=None):
    ...
    for i, line in tqdm(enumerate(valid_manifest)):
        ...
        # else:
        #     instructions.append("")
        instructions.append(line["context"])
        ...
        answer_list.append(convs[1]["value_normalized"]) #["text_value"])
        # Language target
        if "lang" in convs[1]:
        ...
        for i in range(0, len(convs), 2):
            ...
            cut.supervisions.append(
                SupervisionSegment(
                    ...
                    text=convs[i]["value_normalized"], #["text_value"],
            ...
            cut.supervisions.append(
                SupervisionSegment(
                    ...
                    text=convs[i + 1]["value_normalized"], #["text_value"],
